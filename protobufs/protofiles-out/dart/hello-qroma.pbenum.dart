...
class NoArgCommands extends $pb.ProtobufEnum {
  static const NoArgCommands Nac_NotSet = NoArgCommands._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Nac_NotSet');
  static const NoArgCommands Nac_GetBoardDetailsRequest = NoArgCommands._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Nac_GetBoardDetailsRequest');
